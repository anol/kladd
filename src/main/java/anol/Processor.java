...
public class Processor {
    ...
    public Processor(String inputFileName, String outputFileName, String pageSize) throws Throwable {
        ...
        if (outputFile.getName().endsWith(".svg")) {
            ...
            outputString = converter.convertToPs(outputFile.getName(), pageSize);
            new FileOutputStream(outputFile).write(outputString.getBytes());
        } else {
            ...
            converter.convertToPdf(temp, outputFile, pageSize);
        }
    }
